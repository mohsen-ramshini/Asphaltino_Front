        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-4 text-sm text-slate-600">
              ...
              <span>
                Total Budget:{" "}
                <span className="font-semibold text-slate-800">$12,400</span>
              </span>
            </div>
          </div>
          ...
          <div className="ml-6">
            ...
            <Radio.Group
              ...
              size="small"
            >
              <Radio.Button value="a" className="text-xs font-medium">
                ALL
              </Radio.Button>
              <Radio.Button value="b" className="text-xs font-medium">
                ONLINE
              </Radio.Button>
              <Radio.Button value="c" className="text-xs font-medium">
                SENSORS
              </Radio.Button>
            </Radio.Group>
          </div>
                ...
                >
                  <td className="p-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h6 className="font-semibold text-slate-900 mb-1 truncate">
                          {d.Title}
                        </h6>
                  ...
                  <td className="p-4">
                    <div className="space-y-2">
                      ...
                      <div className="w-full">{d.progress}</div>
                    </div>
                  </td>
                  <td className="p-4">
                    <div className="text-center">
