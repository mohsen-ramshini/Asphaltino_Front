...
function Sidenav({
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      {/* Brand / Logo */}
      <div
        className={`h-16 flex items-center justify-center border-b border-gray-100 px-2`}
      >
        Intasphalt
      </div>
      ...
      <div className="p-4 border-t border-gray-100 mt-auto flex flex-col items-center">
          ...
          className={`w-full flex items-center px-4 py-2 text-sm rounded-lg transition-colors duration-200 mb-3
            ${
              collapsed
                ...
                : "justify-center bg-blue-500 text-white hover:bg-blue-600"
            } // حالت باز: متن و آیکون وسط
          `}
        ...
        {!collapsed && (
          <div className="text-center text-xs text-gray-500">
            <p className="font-medium">IntAsphalt v1.0</p>
